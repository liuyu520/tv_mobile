...
<div style="text-align:center;" class="pagingDiv">
    <form id="form_subpage" method="POST" onsubmit="return checkPageForm()">
		...
		<span style="color: black">共
				...
				<c:choose>
                    ...
                    <c:otherwise>
                        <a name="firstPageHref" href="javascript:toPageFirst($('#form_subpage'),${param.action});"
                           style="color:#fff;">首
                            页</a>
                    </c:otherwise>
                </c:choose>
				...
				<c:choose>
                    ...
                    <c:otherwise>
                        <a name="previousPageHref" href="javascript:toPagePre($('#form_subpage'),${param.action});"
				...
				<c:choose>
                    ...
                    <c:otherwise>
                        <a name="nextPageHref" href="javascript:toPageNext($('#form_subpage'),${param.action});">下一页</a>
                    </c:otherwise>
                </c:choose>
				...
				<c:choose>
                    ...
                    <c:otherwise>
                        <a name="endPageHref" href="javascript:toPageLast($('#form_subpage'),${param.action});">尾页</a>
                    </c:otherwise>
                </c:choose>
			<c:if test="${view.totalPages>1 }">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <input type="text" id="view.currentPage" style="width:80px;" onkeyup="onlyIntegerKeyUp(event)"
                               name="currentPage"
