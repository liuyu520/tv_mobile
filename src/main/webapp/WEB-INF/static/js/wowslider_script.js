...
function ws_seven(t, e, i) {
    ...
    function o(t, e, i, o, r) {
        ...
        return b > v && (v = b), y > x && (x = y), d(t).each(function (t) {
            var e = t % f, r = Math.floor(t / f), b = .2 * p * (45 * a(e, f) + 4 * r) / (f * g), y = M.offset().left + T.l + c * e - s * l / 2 + c, I = M.offset().top + T.t + w * r - h * l / 2 + w, z = n(y, I, x, v), C = {
                opacity: 1,
                left: s * e / f,
                top: h * r / g,
                width: s / f,
    ...
    var d = jQuery, c = d(this), l = t.distance || 5, f = t.cols, g = t.rows, p = 2 * t.duration, w = t.blur || 50, u = (i.find(".ws_list"), []), m = [], v = d("<div>").css({
        position: "absolute",
        top: 0,
        left: 0,
        width: "100%",
...
function ws_cube(t, e, i) {
    ...
    var n = jQuery, o = n(this), r = /iPhone|iPod|iPad|Android|BlackBerry/.test(navigator.userAgent), a = n(".ws_list", i), d = t.perspective || 2e3, h = {
        position: "absolute",
    ...
    var p = {
        domPrefixes: " Webkit Moz ms O Khtml".split(" "), testDom: function (t) {
            ...
            if (t && /AppleWebKit/.test(navigator.userAgent)) {
                var e = document.createElement("div"), i = document.createElement("style"), s = "Test3d" + Math.round(99999 * Math.random());
    ...
    this.go = function (p, l) {
        function m(e, i, o, a, c, p, f, u, l, m) {
            ...
            if (i.front.css({transform: "rotateY(0deg) rotateX(0deg)"}), i.back.css({
                ...
                }), !r)var b = n("<div>").css(h).css("boxShadow", s(v, w, 0, 0)).appendTo(i.front), x = n("<div>").css(h).css("boxShadow", s(v, w, p, f)).appendTo(i.back);
        ...
        if (v = {
            ...
            }[t.direction || ["left", "right", "down", "up"][Math.floor(4 * Math.random())]], T = n("<img>").css(v), y = n("<img>").css(v).attr("src", e.get(p).src), k = n("<div>").css({
                overflow: "hidden",
...
function ws_brick(t, e, a) {
            ...
            for (var h in t)if (!(s + t[h].animate.delay > f)) {
                ...
                if (i = {}, o = "", c > 1) {
                    ...
                    for (var p in t[h].animate[.5 >= c ? "half" : "end"]) {
                        var g = t[h].animate[.5 >= c ? "begin" : "half"][p] || 0, m = t[h].animate[.5 >= c ? "half" : "end"][p] || 0;
    ...
    function i(e, r, i, s) {
        var d = a.width(), l = a.height(), c = d / f, p = l / h, g = .4 * t.duration > 1e3 ? 1e3 : .4 * t.duration, m = .6 * t.duration, u = [0, 0];
    ...
    var d = jQuery, l = d(this), f = t.cols || 4, h = t.rows || 3, c = 2.5, p = 2, g = t.perspective || 2e3, m = a.find(".ws_list"), u = [], w = 30, v = {}, x = d("<div>").addClass("ws_effect").css("overflow", t.responsive > 1 ? "hidden" : "visible"), b = t.support.transform && t.support.transition && t.support.perspective, y = /Safari/.test(navigator.userAgent) && !/Chrome/.test(navigator.userAgent), k = /Firefox/.test(navigator.userAgent);
    a = a.parent().append(x);
    var T = [{
        zIndex: 0,
        rotateX: 360,
    ...
    this.go = function (n, o) {
        ...
        for (var g = 0; f * h > g; g++) {
            var Y = g % f, X = Math.floor(g / f), I = d("<div>").css({
                ...
                outline: "1px solid transparent",
                transformStyle: "preserve-3d"
            }).appendTo(I), S = d("<div>").addClass("ws_front_image").appendTo(_), z = b ? d("<div>").addClass("ws_back_image").appendTo(_) : 0;
            S.css({
                position: "absolute",
                width: "100%",
                height: "100%",
        ...
        if (L = {
            ...
            for (var Z in u) {
                $img2 = u[Z].front.find("img");
                if ($img2.length !== 0 && e !== undefined && e.length !== 0)$img2.attr("src", e.get(o).src), u[Z].back.find("img").attr("src", e.get(n).src);
            }
            ...
            for (var Z in u) {
                ...
                var j = t.duration * (1 - Math.abs((p * c - Y * X) / (2 * h * f))), q = s(-1, 1) > 0 ? 1 : -1, M = s(-1, 1) > 0 ? 1 : -1;
...
(function ($) {
     ...
     */
    var $wowsliderImg = $("#wowslider-container");
    if ($wowsliderImg.find("div>ul>li img").length !== 0) {
        var wowSlider = $wowsliderImg.wowSlider({
