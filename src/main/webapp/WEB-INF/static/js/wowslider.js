...
jQuery.fn.wowSlider = function (t) {
    ...
    function y() {
        ...
        if (q.find(".ws_bullets a,.ws_thumbs a").click(function (t) {
            ...
            t.gestures && u(q, 1, function (e, i, a) {
                var o = Math.min(Math.max(r + i, ye.width() - n.width()), 0), s = Math.min(Math.max(l + a, ye.height() - n.height()), 0);
                t.support.transform && t.support.transition ? n.css({
                    transition: "0ms linear",
        ...
        if (we.length) {
            ...
            if (p.length) {
                var h = z('<div class="ws_bulframe"/>').appendTo(c), m = z("<div/>").css({width: p.length + 1 + "00%"}).appendTo(z("<div/>").appendTo(h));
            ...
            if (n == e) {
                ...
                if (i.addClass("ws_selthumb"), !Te) {
                    ...
                    if (t.support.transform && t.support.transition) {
                        a = d(o);
                        var r = -Math.max(Math.min(s.left, -a.left), s.left + i.width() - ye.width()), l = -Math.max(Math.min(s.top, 0), s.top + i.height() - ye.height());
    ...
    function _(t) {
        ...
        return (n !== undefined && n.replace(/\s+/g, "")) || (n = ""), (n ? "<span>" + n + "</span>" : "") + (i ? "<br><div>" + i + "</div>" : "")
    }
    ...
    function E(t, e) {
        ...
        var s = e.direction || "left", r = "up" == s || "down" == s ? "top" : "left", l = "up" == s || "left" == s, u = e.distance || ("top" == r ? t.outerHeight(!0) : t.outerWidth(!0));
    ...
    function k(e, n, i, a, o, s) {
        ...
        if (l *= c / 100, u *= c / 100, i == a)r(e, u).fadeIn(o / 3), r(z(">div,>span", e), 0).css("display", "inline-block"); else {
            var d = z(">div", e).css("display", "inline-block"), f = z(">div", n).css("display", "inline-block"), p = z(">span", e), h = z(">span", n), m = l + c * (s ? -1 : 1), v = u, g = u, w = l + c * (s ? 1 : -1), y = (s ? -1 : 1) * l, b = 0;
            ...
            P(function (t) {
                ...
                P(function (t) {
                    ...
                    var e = 2 * (1 - x) * y + x * b, n = (1 - x) * y + x * b, i = (1 - x) * b + -2 * x * y, a = (1 - x) * b + x * -y;
    ...
    var D = t.images && new wowsliderPreloader(this, t), j = N.find("li"), R = j.length, W = (V.width() / V.find("li").width(), {
        position: "absolute",
        top: 0,
        height: "100%",
        overflow: "hidden"
    }), H = z("<div>").addClass("ws_swipe_left").css(W).prependTo(V), Q = z("<div>").addClass("ws_swipe_right").css(W).appendTo(V), $ = navigator.userAgent;
    ...
    if (de && (de = s(de))) {
        ...
        if (z(ce).css({
            ...
            var Fe = z('<a href="#" class="ws_next">' + t.next + "</a>"), Se = z('<a href="#" class="ws_prev">' + t.prev + "</a>");
        ...
        if (t.caption) {
            var Pe = z("<div class='ws-title' style='display:none'></div>"), ke = z("<div class='ws-title' style='display:none'></div>"), Ae = z("<div class='ws-title-wrapper'>").append(Pe, ke);
        ...
        if (ze) {
            if (window.Audio && ze.canPlayType && ze.canPlayType("audio/mp3"))ze.loop = "loop", t.autoPlay && (ze.autoplay = "autoplay", setTimeout(function () {
                ...
                ze = ze.src;
                var Le = ze.substring(0, ze.length - /[^\\\/]+$/.exec(ze)[0].length), Ne = "wsSound" + Math.round(9999 * Math.random());
